...
namespace AdventOfCode._2018
{
    class Day15 : Solution
    {
        ...
        class Map
        {
            private Dictionary<Entity, Point2D> fByEntity = new Dictionary<Entity, Point2D>();
            private Dictionary<Point2D, Entity> fByPosition = new Dictionary<Point2D, Entity>();
            ...
            public Map(string input, int ElfAttack)
            {
                ...
                foreach (var (c, pos) in ents)
                {
                    switch (c)
                    {
                        ...
                        case 'G': Add(new Creature(c, DefaultAttack), pos); break;
        ...
        private (long Score, bool DeadElves) SimulateFight(string input, int elfAttackPower = DefaultAttack, bool StopOnDeadElf = false)
        {
        ...
        private long WithBoostedElves(string input)
            => EnumerableHelper.Generate(DefaultAttack + 1)
