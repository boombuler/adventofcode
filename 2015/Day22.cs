...
namespace AdventOfCode._2015
{
    class Day22 : Solution
    {
        ...
        {
            public static readonly Spell MagicMissile = new Spell(0, Cost: 53, Damage: 4, Duration: 1);
            public static readonly Spell Drain = new Spell(1, Cost: 73, Damage: 2, Heal: 2, Duration: 1);
            public static readonly Spell Shield = new Spell(2, Cost: 113, Armor: 7, Duration: 6);
            public static readonly Spell Poison = new Spell(3, Cost: 173, Damage: 3, Duration: 6);
            public static readonly Spell Recharge = new Spell(4, Cost: 229, Mana: 101, Duration: 5);
        ...
        private long PlayGame(int mana, int playerHP, int bossHP, int bossDmg, int malus = 0)
        {
