...
namespace _2017_03
{
    class Program : ProgramBase
    {
        ...
        private const long INPUT = 289326;
        private long GetMDForCell(long number)
        {
        ...
        private IEnumerable<Point2D> WalkSpiral()
        {
        ...
        private long StressTest(long maxValue)
        {
            var values = new Dictionary<Point2D, long>();
            values[(0, 0)] = 1;
