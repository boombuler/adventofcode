...
namespace AdventOfCode._2019
{
    ...
    {
        private int Factor(int digit, int idx)
        {
            idx++;
            idx /= digit + 1;
        ...
        private void FFTRound(IEnumerable<char> input, char[] output)
        {
        ...
        private string FTT(string input, int rounds, int offset = 0, int digits = 8)
        {
