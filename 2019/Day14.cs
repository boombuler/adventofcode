...
namespace AdventOfCode._2019
{
    class Day14 : Solution
    {
        record MatAmount(long Amount, string Material)
        {
            ...
            public static MatAmount operator *(MatAmount a, long c) => new MatAmount(a.Amount * c, a.Material);
        }

        private long GetRequiredOre(string reactionText, long fuelAmount = 1)
        {
            var reactions = (
        ...
        private long MaxFuel(string reactionText, long TotalOre = 1_000_000_000_000)
        {
            long a = 1;
            long b = TotalOre;
