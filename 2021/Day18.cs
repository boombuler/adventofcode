...
namespace AdventOfCode._2021
{
    class Day18 : Solution
    {
        class SFNumber
        {
            ...
            {
                while (Explode(0) || Split()) /* do nothing */ ;
                return this;
            }

            private SFNumber Neighbour(SFNumber node, Func<SFNumber, SFNumber> wantedSide, Func<SFNumber, SFNumber> otherSide)
            {
        ...
        {
            long LargestMag(string input)
                => input.Lines()
                    .Combinations(2)
                    .SelectMany(r => new[] { (A: r.First(), B: r.Last()), (A: r.Last(), B: r.First()) })
