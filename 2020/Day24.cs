...
class Day24 : Solution
{
    ...
    */
    ...
    private static long CountBlackTiles(string input) => ReadPattern(input).Count;

    private static readonly Regex ParseLine = new("(nw|ne|sw|se|e|w)", RegexOptions.Compiled);
    private static HashSet<(int r, int c)> ReadPattern(string input)
    {
    ...
    private static long GameOfTiles(string input, int days)
    {
